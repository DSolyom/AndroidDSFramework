...
public abstract class MultiCursorRecyclerViewAdapter extends AbsTemplateViewHolderAdapter<CursorListEntry> {
	...
	public MultiCursorRecyclerViewAdapter(ActivityInterface in, int rowLayoutId) {
